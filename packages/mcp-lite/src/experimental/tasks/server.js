...
export class ExperimentalServerTasks {
     ...
     * @experimental
     */
    async *createMessageStream(params, options) {
        ...
        yield* this.requestStream({
            method: 'sampling/createMessage',
            params
        }, (await T()).CreateMessageResultSchema, options);
    }
    /**
     ...
     * @experimental
     */
    async *elicitInputStream(params, options) {
        // Access client capabilities via the server
        const clientCapabilities = this._server.getClientCapabilities();
        ...
        }, (await T()).ElicitResultSchema, options);
    }
    /**
